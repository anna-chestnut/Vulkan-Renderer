...
namespace vr
{
    ...
    VrPipeline::~VrPipeline()
    {
        ...
        vkDestroyPipeline(vrDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    void VrPipeline::createGraphicsPipeline(const std::string &vertFilePath, const std::string &fragFilePath, const PipelineConfigInfo &configInfo)
    {
    ...
    void VrPipeline::bind(VkCommandBuffer commandBuffer){
        vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
    }


    PipelineConfigInfo VrPipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height) {
